...
# Import Data Set
with h5py.File('Diabetic_Sim3.h5py', 'r') as data:
...
p_dict1 = {param[0]: sim_data['meta_data'][(1+100*i):(101+i*100),i+1] for 
        i, param in enumerate(sample_list[:12])}
max_d_dict1 = {param[0]: max_D[1+100*i:101+i*100] for i, param 
    in enumerate(sample_list[:12])}

# bMV to bEM
dict2 = {param[0]: sim_data['meta_data'][(1+100*(i+12)):(101+(i+12)*100),i+14] for 
    i, param in enumerate(sample_list[12:18])}
max_d_dict2 = {param[0]: max_D[1+100*(i+12):101+(i+12)*100] for i, param 
    in enumerate(sample_list[12:18])}

# bEI
dict3 = {param[0]: sim_data['meta_data'][(1+100*(i+18)):(101+(i+18)*100),i+21] for 
    i, param in enumerate(sample_list[18])}
max_d_dict3 = {param[0]: max_D[(1+100*(i+18)):(101+(i+18)*100)] for i, param
    in enumerate(sample_list[18])}    

# Rest
dict4 = {param[0]: sim_data['meta_data'][(1+100*(i+19)):(101+(i+19)*100),i+25] for 
    i, param in enumerate(sample_list[19:])}
max_d_dict4 = {param[0]: max_D[(1+100*(i+19)):(101+(i+19)*100)] for i, param
    in enumerate(sample_list[19:])}

p_dict2 = dict(**dict2, **dict3, **dict4)
max_d_dict2 = dict(**max_d_dict2, **max_d_dict3, **max_d_dict4)
